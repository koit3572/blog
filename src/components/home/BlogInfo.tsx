...
const BlogInfo = () => {
  ...
  return (
    <div className="relative flex w-[45rem] max-w-[calc(100%-3rem)] flex-col items-center xl:w-[80rem]">
      <div className="absolute left-[1rem] top-[-1rem] h-[25rem] w-full max-w-[100%] bg-gray-400 xl:left-[3.5rem] xl:top-[-5rem] xl:h-[25rem] xl:w-[40rem]" />
      <div className="left-[2.5rem] top-[-4rem] z-10 flex h-[25rem] w-full max-w-[100%] flex-col items-center justify-center gap-1 bg-gray-300 p-6 text-center xl:absolute xl:h-[25rem] xl:w-[40rem] xl:flex-row">
