...
export const QuoteList = [
  ...
  { quote: "강인한 의지 없이는 뛰어난 재능도 없다.", author: "오노레 드 발자크" },
  ...
  { quote: "한번 포기하면 습관이 된다. 절대 포기하지 말아라", author: "마이클 조던" },
  { quote: "나이가 성숙을 보장하지 않는다.", author: "라와나 블랙웰" },
  { quote: "성공은 꿈꾸고, 믿고, 대담해지고, 실천하는데서 오는 것이다.", author: "존 디줄리어스 3세" },
  { quote: "삶은 당신이 만드는 것이다. 이전에도 그랬고 앞으로도 그럴 것이다.", author: "그랜마 모세" },
  ...
  { quote: "무엇을 시도할 용기도 없으면서 멋진 삶을 바란단 말인가.", author: "반 고흐" },
  { quote: "가장 높이 나는 갈매기가 가장 멀리 본다.", author: "리처드 바크" },
  { quote: "목표를 높게 잡아라. 그리고 도달할 때까지 멈추지 말라.", author: "보 잭슨" },
  { quote: "슬기로운 자는 미래를 현재인 양 대비한다.", author: "명심보감" },
  { quote: "행복은 습관이다. 그것을 몸에 지니라.", author: "엘버트 하버드" },
  { quote: "기회는 새와 같은 것, 날아가기 전에 꼭 잡아라.", author: "스마일즈" },
  ...
  { quote: "생각을 집중해야 바라던 결과를 얻을 수 있다.", author: "지그 지글러" },
  { quote: "말도 행동이고 행동도 말의 일종이다.", author: "랄프 왈도 에머슨" },
  { quote: "시간은 언제 까지든 당신을 기다리는 것은 아니다.", author: "짐멜" },
  { quote: "오늘 죽을 것처럼 행동하고 영원히 살 것처럼 배워라.", author: "마하트마 간디" },
  { quote: "인생의 본분은 전진이다.", author: "S.존슨" },
  { quote: "실수를 두려원 말고 계속 도전하라.", author: "전 시몬즈" },
  { quote: "상황을 가장 잘 활용하는 사람이 가장 좋은 상황을 맞는다.", author: "존 우든" },
  { quote: "장애가 크면 클수록 성취의 영관은 커지는 법이다.", author: "몰리에르" },
  { quote: "앞서 가는 방법의 비밀은 시작하는 것이다.", author: "마크 트웨인" },
  { quote: "건강은 제일의 재산이다.", author: "랄프 왈도 에머슨" },
  { quote: "때때로 우리는 너무 많이 생각하고, 너무 적게 느낀다.", author: "찰리 채플린" },
  { quote: "가장 어두운 밤도 언젠간 끝나고 해는 떠오를 것이다.", author: "반 고흐" },
  { quote: "시간은 인간이 쓸 수 있는 가장 값진 것이다.", author: "테오프라스토스" },
  { quote: "산다는 것은 호흡하는 것이 아니라 행동하는 것이다.", author: "장 자크 루소" },
  { quote: "성공은  영원하지 않으며, 실패 역시 그러하다.", author: "델 크로스워드" },
  { quote: "사간은 가장 희소가치가 있는 부족한 자원이다.", author: "피터 드러커" },
...
const MainHeader = () => {
  return (
    <div className="flex flex-col h-[65vh] min-h-[800px] pt-[10rem]">
      ...
      <div className="flex flex-col items-center w-full pb-16  text-gray-200">
        <p className="text-[3rem] font-[600]">KoIT의 웹 개발 블로그</p>
        <div className="w-[30rem] h-[0.2rem] bg-gray-100" />
        <p>한번의 기록으로 영원한 기억을</p>
      </div>
